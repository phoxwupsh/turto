use std::{sync::Arc, collections::{HashMap, VecDeque}, ops::{Deref, DerefMut}, time::Duration};
...
use serde::{
    ...
    de::{Deserialize, Deserializer, MapAccess, Visitor, self}
};
...
impl<'de> Deserialize<'de> for Metadata {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
        ...
        enum Field {Track, Artist, Date, Channels, Channel, StartTime, Duration, SampleRate, SourceUrl, Title, Thumbnail}
        ...
        const FIELDS: &[&str] = &["track", "artist", "date", "channels", "channel", "start_time", "duration", "sample_rate", "source_url", "title", "thumbnail"];
